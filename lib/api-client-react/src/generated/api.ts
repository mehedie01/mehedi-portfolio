...
export const getCreateContactMessageMutationOptions = <TError = ErrorType<ContactError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateContactMessageMutationError = ErrorType<ContactError>

    /**
 * @summary Submit a contact form message
 */
export const useCreateContactMessage = <TError = ErrorType<ContactError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createContactMessage>>, TError,{data: BodyType<ContactMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
